...
public class OrderLineTemp {
    ...
    public OrderLineTemp() {
    }

    public OrderLineTemp(String NAME, String PRICE, String CUSINE_CATEGORY, String CITY, String REGION, String URL, String PAGE_NO, String CUSINE_TYPE, String TIMING, String RATING_TYPE, String RATING, String VOTES) {
        this.NAME = NAME;
        this.PRICE = PRICE;
        this.CUSINE_CATEGORY = CUSINE_CATEGORY;
        this.CITY = CITY;
